# cira_codec.py — ES8311 音频 DAC 编解码器 MicroPython 驱动
# 移植自板子 ref_es8311.py（官方 Waveshare 1.85C-BOX V2 配置：I2S 从机、
# 16-bit、无 MCLK（BCLK 提供时钟）、PA=GPIO15），改用共享 I2C。
...
class ES8311:
    def __init__(self, addr=ES8311_ADDR):
